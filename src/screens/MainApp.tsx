...
const styles = StyleSheet.create({
  ...
  quickRow: { flexDirection: 'row', alignItems: 'stretch', gap: 12 },
  quickPress: { flex: 1 },
  quickCard: { height: 164, position: 'relative' },
  ...
  foodImageWrap: { height: 142, width: '100%', position: 'relative', overflow: 'hidden', borderTopLeftRadius: 28, borderTopRightRadius: 28 },
  foodCardImage: { width: '100%', height: 142 },
